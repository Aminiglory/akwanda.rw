...
const dictionaries = {
  en: {
    ...
    nav: {
      ...
      bookingComMessages: 'AkwandaTravels.com messages',
    ...
    footer: {
      ...
      apartments: 'Apartments',
      bottomCopyright: (year) => ` ${year} AkwandaTravels.com. All rights reserved.`,
    },
    hero: {
      title: 'Welcome to AkwandaTravels.com',
    ...
    home: {
      ...
      listCtaTitle: 'List your property with AkwandaTravels.com',
    ...
    testimonials: {
      ...
      ctaMessage: "Whether you're looking for a place to stay or want to earn from your space, AkwandaTravels.com is here for you.",
    ...
    auth: {
      ...
      loginSubtitle: 'Sign in to your AkwandaTravels.com account',
      email: 'Email address',
      password: 'Password',
      signIn: 'Sign in',
      ...
      registerSubtitle: 'Join AkwandaTravels.com and start your apartment journey',
      iWantTo: 'I want to',
