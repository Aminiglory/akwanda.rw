      ...
      <div className="relative bg-gradient-to-r from-[#a06b42] via-[#8f5a32] to-[#a06b42] shadow-xl overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">{t ? t('vehicles.title') : 'Vehicle Rentals'}</h1>
            <p className="text-xl md:text-2xl text-white/90 font-medium">{t ? t('vehicles.subtitle') : 'Find the perfect vehicle (car, motorcycle, or bicycle)'}</p>
          </div>
        </div>
      </div>
