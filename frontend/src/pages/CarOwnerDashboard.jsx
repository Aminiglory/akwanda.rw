  ...
  return (
    <div className="min-h-screen bg-[#f9f5ef] py-4">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                      ...
                      {cars.map((c) => {
                        ...
                        return (
                          <tr key={id} className="hover:bg-[#fdf7ee] transition-colors">
                            ...
                            <td className="px-3 py-2 align-top">
                              <span
                                className={`inline-flex items-center px-2 py-0.5 rounded-full border text-[10px] ${isAvailable
                  ...
                  return top.map(b => {
                    ...
                    return (
                      <li key={b._id} className="py-2 flex items-start gap-2">
                        <span
                          className={`mt-1 inline-block w-2 h-2 rounded-full ${status === 'completed'
                            ? 'bg-emerald-500'
                            : status === 'cancelled'
                              ? 'bg-red-500'
                              : 'bg-amber-400'
                        ...
                        return (
                          <tr key={b._id} className="hover:bg-[#fdf7ee] transition-colors">
                            ...
                            <td className="px-3 py-2 align-top text-right text-[11px]">
                              <span
                                className={`inline-flex items-center px-2 py-0.5 rounded-full border text-[10px] ${status === 'paid' || status === 'completed'
                                  ? 'bg-emerald-50 border-emerald-200 text-emerald-700'
                                  : status === 'pending'
                          ...
                          {(() => {
                            ...
                            return list.map(a => (
                              <li key={a.key} className="flex items-start gap-2">
                                <span className={`mt-0.5 inline-block w-2 h-2 rounded-full ${a.type === 'overdue' ? 'bg-red-500' : 'bg-amber-400'
                                  }`} />
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {['car', 'motorcycle', 'bicycle'].map(x => (
                            <button
                              ...
                              className={`px-4 py-3 rounded-xl border-2 transition-all duration-200 font-medium ${category === x
                                  ...
                                  <tr key={b._id} className="border-t border-[#f0e6d9] hover:bg-[#fffaf4]">
                                    <td className="px-4 py-3 text-sm font-medium text-[#3b2a18]">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${b.channel === 'direct'
                                    ...
                                    <td className="px-4 py-3">
                                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium ${b.status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
        ...
        {selectedVehicle && showUpgradeModal && (
