      ...
      {flightStep === 13 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-500">Internal controls for AkwandaTravels.com only.</p>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
            <input
              className="w-full px-4 py-2 border border-gray-200 rounded-xl"
      ...
      <div className={embedded ? '' : 'max-w-4xl mx-auto px-4'}>
        {!embedded && (
          <div className="mb-8">
            ...
            <p className="text-gray-600">Choose what you want to list, then follow the steps to publish it on AkwandaTravels.com.</p>
          </div>
        )}
