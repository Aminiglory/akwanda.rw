...
const commissionSettingsRouter = require('./src/routes/commissionSettings');
const adminLandingRouter = require('./src/routes/adminLanding');
const adminAttractionsRouter = require('./src/routes/adminAttractions');
const adminRentalsRouter = require('./src/routes/adminRentals');
const adminFlightsRouter = require('./src/routes/adminFlights');
...
const carFinanceRouter = require('./src/routes/carFinance');
const attractionFinanceRouter = require('./src/routes/attractionFinance');
const carMaintenanceRouter = require('./src/routes/carMaintenance');
const carToursRouter = require('./src/routes/carTours');
const carTripRoutesRouter = require('./src/routes/carTripRoutes');
const carFuelLogsRouter = require('./src/routes/carFuelLogs');
const carIncomeRouter = require('./src/routes/carIncome');
const carClientsRouter = require('./src/routes/carClients');
const carContractsRouter = require('./src/routes/carContracts');
...
const ownerFlightsRouter = require('./src/routes/ownerFlights');
...
app.use('/api/admin', adminRentalsRouter);
app.use('/api/admin', adminFlightsRouter);
app.use('/api/admin', adminRouter);
app.use('/api/admin/commission-settings', commissionSettingsRouter);
...
app.use('/api/attraction-finance', attractionFinanceRouter);
app.use('/api/car-maintenance', carMaintenanceRouter);
app.use('/api/car-tours', carToursRouter);
app.use('/api/car-trip-routes', carTripRoutesRouter);
app.use('/api/car-fuel-logs', carFuelLogsRouter);
app.use('/api/car-income', carIncomeRouter);
app.use('/api/car-clients', carClientsRouter);
app.use('/api/car-contracts', carContractsRouter);
